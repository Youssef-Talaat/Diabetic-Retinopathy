			...
			<?php
					...
					<div class='container'>
								...
								<div class='row'>
									...
									<div class='col-md-2 col-sm-6 animate-box'>
										<div class='desc'>
											<p class='wrap'>
												<span class='icon'><i>%</i></span>
												<span class='colorlib-counter js-counter' data-from='0' data-to='11' data-speed='1000' data-refresh-interval='50'></span>
											</p>
									...
									<div class='col-md-2 col-sm-6 animate-box'>
										<div class='desc'>
											<p class='wrap'>
												<span class='icon'><i>%</i></span>
												<span class='colorlib-counter js-counter' data-from='0' data-to='45' data-speed='1000' data-refresh-interval='50'></span>
											</p>
									...
									<div class='col-md-2 col-sm-6 animate-box'>
										<div class='desc'>
											<p class='wrap'>
												<span class='icon'><i>%</i></span>
												<span class='colorlib-counter js-counter' data-from='0' data-to='30' data-speed='1000' data-refresh-interval='50'></span>
											</p>
						...
						<div class='form-group text-center' align='right'>
							<input type='submit' value='Print Report' name='printReport' class='btn btn-primary'>
						</div>
					</form><br>";
